...
var m = {
    inicio: function(){
        for(var i = 0; i < p.paginacion.length; i++){
            ...
            p.imgSlide[i].style.width = (100/p.paginacion.length) + "%"; /*para poder seccionar en la cantidad imagenes que haya */
        }
        p.avanzar.addEventListener("click", m.avanzar)
		p.retroceder.addEventListener("click", m.retroceder)
        m.intervalo();
        p.cajaSlide.style.width = (p.paginacion*100)+"%"; /*para aumentar el espacio de los slides si aumenta a 5 sera 500% */
        p.imgSlide
    },
