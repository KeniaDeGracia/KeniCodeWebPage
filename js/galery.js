...
var mg = {
    ...
    lightbox: function(img){
        /*crea un div sin tener que escribirlo en el html lo crea el js cuando hago click */
		...
		pg.lightbox.style.position = "fixed"; /*fija */
		pg.lightbox.style.zIndex = "10"; /*delante de cualquier objeto */
		...
		pg.modal.innerHTML = img.outerHTML+"<div>x</div>"; /*al llamar al inner esta trayendo el objeto y se utiliza outter para traer la caja */
		...
		/*media query o puntos de quiebre como en css en filas y columnas para responsive */
		...
		if(pg.animacionGaleria == "slideLeft"){
			...
			setTimeout(function(){
                ...
                /*da el ancho y alto y lo divide entre 2 para poder centrarla */
			},50)
